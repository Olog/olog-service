        ...
        <fieldset>
            ...
            <div id='logFormContainer'>
                <div id='logFormInfo'>
                    ...
                    <div id='logFormUploads'>
                        <?php //echo '<a href="javascript:addElement()">add another file</a>'; ?>
                        <?php //echo $this->Form->input('Upload.0.file', array('type' => 'file', 'div' => array('id' => 'fileDivId'))); ?>
                    </div>
                </div>
    ...
    <div id="menu">
        ...
        ?>
                     ...
                     <!--           <td class="id"><?php echo $log['id']; ?></td> -->
                                <td class="subject">
                                    <div id='subject'><?php echo $log['subject']; ?></div>
