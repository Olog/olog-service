...
<div class="logs index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $log['createdDate']; ?>&nbsp;<br><div class="edited"><?php if($log['version']>0)echo '[edited]'; ?></div></td>
		<td>
			<?php echo $this->Html->link($log['level'], array('controller' => 'levels', 'action' => 'view', $log['level'])); ?>
		</td>
		<td><?php echo $log['subject']; ?>&nbsp;&nbsp<br>
		    <?php echo $log['description']; ?>
		    <div class="tag"><?php foreach ($log['tags'] as $tag) echo $tag['name'].'&nbsp;|&nbsp;';
		    foreach ($log['logbooks'] as $logbook) echo $logbook['name'].'&nbsp;|&nbsp;';?></div></td>
		<td>
