ALTER TABLE `logs_logbooks` MODIFY COLUMN `log_id` INT(11) UNSIGNED NOT NULL,
...
ALTER TABLE `logs` MODIFY COLUMN `id` INT(11) UNSIGNED NOT NULL;

ALTER TABLE `properties` MODIFY COLUMN `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `subscriptions` MODIFY COLUMN `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
 MODIFY COLUMN `tag_id` INT(11) UNSIGNED NOT NULL,
 DROP FOREIGN KEY `subscriptions_tag_id_fk`;

ALTER TABLE `logbooks` MODIFY COLUMN `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
 MODIFY COLUMN `is_tag` INT(1) UNSIGNED NOT NULL DEFAULT 0;

ALTER TABLE `attributes` ADD CONSTRAINT `attributes_property_id_fk` FOREIGN KEY `attributes_property_id_fk` (`property_id`)
    REFERENCES `properties` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;

ALTER TABLE `logs_attributes` ADD CONSTRAINT `logs_attributes_attribute_id_fk` FOREIGN KEY `logs_attributes_attribute_id_fk` (`attribute_id`)
...
ALTER TABLE `logs` MODIFY COLUMN `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;
